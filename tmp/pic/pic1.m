...
%% wind_smc
hold on
A=reshape(logsout{18}.Values.Data,1,4780);B=reshape(logsout{19}.Values.Data,1,4780);
C=reshape(logsout{8}.Values.Data,1,4780);
%A(3010:3062)=A(3010:3062)/4;A(3404:3800)=(A(3404:3800)-2)/4+2;
...
figure,
hold on
plot(logsout{38}.Values.Data(3010:4100)-30,A(3010:4100),'k')
xlabel('t(s)');%ylabel('(m)',"Rotation",90)
plot(logsout{38}.Values.Data(3010:4100)-30,B(3010:4100),'k--')
xlabel('t(s)');
plot(logsout{38}.Values.Data(3010:4100)-30,C(3010:4100),'k-.')
xlabel('t(s)');xlim([0 11])
legend(["x" "y" "z"])